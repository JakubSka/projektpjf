     ...
     const customSelect = document.querySelector('.custom-select');
              ...
              innerArray.forEach(property => {
                  updateDistrictData(property);
                    ...
                    listItem.innerHTML = `
                      ...
                      <p><a href="https://www.olx.pl${property.url}" target="_blank">Link do oferty</a></p>
                    `;
        ...
        L.geoJSON(geojsonData, {
            pointToLayer: function (feature, latlng) {
                ...
                let name = switchSign(decodeURIComponent(feature.properties.name));
    ...
    sortSelect.addEventListener('change', function () {
            ...
            let allListItems = Array.from(propertyList.querySelectorAll('li'));
